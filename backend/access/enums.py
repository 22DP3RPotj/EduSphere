...
class PermissionCode(models.TextChoices):
    ...
    ROOM_UPDATE = "room.update", "Update room settings"
    ROOM_MANAGE_VISIBILITY = "room.manage_visibility", "Manage room visibility settings"
    ROOM_MANAGE_PARTICIPANTS = (
        "room.manage_participants",
        "Invite or remove participants",
    )
    ROOM_MANAGE_ROLES = "room.manage_roles", "Manage room roles and permissions"
