...
rules.add_perm(AccountPermission.BAN, is_admin)
rules.add_perm(AccountPermission.PROMOTE, is_admin)
rules.add_perm(AccountPermission.VIEW_PRIVATE, is_admin | is_account_owner)
