...
class RoomMutationsTests(JSONWebTokenTestCase):
    ...
    def test_create_room_success(self):
        ...
        mutation = """
            mutation CreateRoom($name: String!, $topicNames: [String!]!, $description: String!, $visibility: Visibility!) {
    ...
    def test_update_room_success(self):
        ...
        self.client.authenticate(self.user)
        mutation = """
            mutation UpdateRoom($roomId: UUID!, $name: String, $description: String, $visibility: Visibility) {
    ...
    def test_join_room_success(self):
        ...
        result: ExecutionResult = self.client.execute(mutation, variables)
        self.assertIsNone(result.errors)
        self.assertTrue(Participant.objects.filter(user=self.other_user, room=room).exists())
